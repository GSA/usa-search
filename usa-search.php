...
function usa_search_settings() {
    ...
    $search_version=  get_option('search_version');



    $html = '
<form action="options.php" method="post" name="options">
  <h2>USA Search Settings</h2>
  ...
  <table class="form-table" width="100%" cellpadding="10">
    <tbody>
      <tr>
        <td scope="row" aligni="left"><label>Affiliate name:</label>
          <input type="text" name="affiliate_name" size="60" value="' . $affiliate_name . '"></td>
      </tr>
      <tr>
        <td scope="row" aligni="left"><label>API key</label>
          <input type="text" name="api_key" size="60" value="' . $api_key . '"></td>
      </tr>
      <tr>
        <td scope="row" aligni="left"><label>Search Domain</label>
          <input type="text" name="domain" size="60" value="' . $domain . '"></td>
      </tr>
      <tr>
  ...
  <input type="hidden" name="page_options" value="affiliate_name,api_key,domain,search_version" />
